...
if __name__ == "__main__":
    ...
    customer_profiles_table = generate_customer_profiles_table(n_customers=5, random_state = 0)
    ...
    terminals_table = generate_terminal_profiles_table(n_terminals=5, random_state = 0)
